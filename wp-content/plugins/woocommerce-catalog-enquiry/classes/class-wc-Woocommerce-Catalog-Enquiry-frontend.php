...
class WC_Woocommerce_Catalog_Enquiry_Frontend {
	...
	public function add_form_for_enquiry_without_popup() {		
		...
		<button class="demo btn btn-primary btn-large" style="margin-top:15px;" onclick="do_toggle();" href="#responsive"><?php echo __('Send an enquiry','woocommerce-catalog-enquiry')?></button>
		<?php }?>
